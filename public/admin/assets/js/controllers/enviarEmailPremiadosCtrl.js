...
(function(){
	...
	angular
	.module('PDIAPa')
	.controller('enviarEmailPremiadosCtrl', function($scope, $rootScope, $timeout, $mdDialog, adminAPI) {
		...
		// A pré-visualização usa o primeiro projeto selecionado - pra conferir um projeto
		// específico (ex: um dos classificados), selecione só ele antes de pré-visualizar.
